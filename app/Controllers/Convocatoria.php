...
class Convocatoria extends BaseController
{
    ...
    public function editar($id)
    {
        ...
        if (!$convocatoria) {
            return redirect()->to(site_url('convocatoria/crear'))->with('error', 'Convocatoria no encontrada.');
        }

        $data = [
            'miga' => 'Administración',
            'url_miga' => base_url() . 'convocatorias',
            'sub_miga' => 'convocatorias',
        ...
        return view('base/administrador/editar_convocatoria', $data);
    }
    public function actualizar($id)
    {
        ...
        try {
            ...
            return redirect()->back()
                ->withInput()
                ->with('error', 'Error al actualizar la convocatoria.');
        }

        return redirect()->to(site_url('convocatoria/crear'))
