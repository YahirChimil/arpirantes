                            ...
                            <div
                                ...
                                <div class="flex flex-col justify-center gap-4">
                                        ...
                                        <div class="card w-1/2">
                                            ...
                                            <div class="card-body p-3">
                                                ...
                                                <form action="<?= base_url('aspirantes/cargarCSV') ?>" method="post"
                                                    ...
                                                    <?= csrf_field() ?>
                                                    <input type="file" name="csv_file" accept=".csv" required class="block text-xs">
                                                    <button type="submit"
                                                ...
                                                <div class="flex justify-end mt-4 gap-4">
                                                    ...
                                                    <button
                                                        type="button"
                                                        class="bg-blue-700 text-white px-4 py-2 rounded shadow hover:bg-blue-800 text-sm"
                                                        onclick="confirmarImpresionSeleccionados()">
                                    ...
                                    <form method="get" class="flex flex-wrap gap-4 mb-6">
                                        ...
                                        <div>
                                            <label for="examen" class="block text-sm font-medium text-gray-700">Examen</label>
                                            <select name="examen" id="examen" class="form-select px-2 py-1 rounded border-gray-300">
                                                <option value="">Todas</option>
                                                <option value="1" <?= ($filtro_examen === '1') ? 'selected' : '' ?>>Sí</option>
                                                <option value="0" <?= ($filtro_examen === '0') ? 'selected' : '' ?>>No</option>
                                            </select>
                                        </div>
                                    ...
                                    <?php if ($buscar || $filtro_sede || $filtro_carrera || $filtro_examen !== ''): ?>
                                        ...
                                        <div class="mb-4 p-3 bg-gray-100 rounded text-sm text-gray-700">
                                            ...
                                            <?php if ($filtro_examen !== ''): ?> | Examen: <span class="font-semibold"><?= $filtro_examen == '1' ? 'Sí' : 'No' ?></span><?php endif; ?>
                                            ...
                                            <table class="min-w-full bg-white border rounded shadow text-sm">
                                                <thead>
                                                    <tr class="bg-gray-200">
                                                        ...
                                                        <th class="px-3 py-2 border advanced-col" style="display:none;">Registrar Examen</th>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                    <?php foreach ($aspirantes as $aspirante): ?>
                                                        <tr>
                                                            ...
                                                            <td class="px-3 py-2 border">
                                                                <?php if ($aspirante['examen'] == 1): ?>
                                                                    <span class="inline-block px-2 py-1 rounded bg-green-100 text-green-800 font-semibold">Aspirante Seleccionado </span>
                                                                <?php else: ?>
                                                                    <span class="inline-block px-2 py-1 rounded bg-red-100 text-red-800 font-semibold">Aspirante no Sleccionado</span>
                                                                <?php endif; ?>
                                                            </td>
                                    ...
                                    <?php elseif ($buscar || $filtro_sede || $filtro_carrera || $filtro_examen !== ''): ?>
...
<script>
    function confirmarImpresionSeleccionados() {
        if (confirm('¿Seguro que deseas imprimir la lista de seleccionados?')) {
            window.open('<?= base_url('aspirantes/imprimirSeleccionados') ?>', '_blank');
        }
    }
</script>
</body>
