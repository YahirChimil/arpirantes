    ...
    <div class="flex grow">
        ...
        <div class="wrapper flex grow flex-col">
            ...
            <div class="p-6 max-w-4xl mx-auto">
                ...
                <form action="<?= base_url('aspirante/actualizar/' . $aspirante['curp']) ?>" method="post"
                        ...
                        <div class="space-y-4">
                            ...
                            <div>
                                ...
                                <input type="text" name="primer_apellido"
                                    value="<?= esc($aspirante['primer_apellido']) ?>"
                                    class="w-full border border-gray-300 rounded-md px-4 py-2 focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                                    required>
                            </div>
                            ...
                            <div>
                                ...
                                <input type="text" name="segundo_apellido"
                                    value="<?= esc($aspirante['segundo_apellido']) ?>"
                                    class="w-full border border-gray-300 rounded-md px-4 py-2 focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                            </div>
                        ...
                        <div class="space-y-4">
                            <div>
                                ...
                                <input type="date" name="fecha_nacimiento"
                                    value="<?= esc($aspirante['fecha_nacimiento']) ?>"
                                    class="w-full border border-gray-300 rounded-md px-4 py-2 focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                            </div>
                            ...
                            <div>
                                ...
                                <select name="genero"
                                    class="w-full border border-gray-300 rounded-md px-4 py-2 focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                                    <option value="M" <?= $aspirante['genero'] == 'M' ? 'selected' : '' ?>>Masculino
                                    </option>
                                    <option value="F" <?= $aspirante['genero'] == 'F' ? 'selected' : '' ?>>Femenino
                                    </option>
