                    ...
                    <div class="mb-6 p-4 border rounded bg-white shadow-sm">
                        ...
                        <?php if ($docSubido): ?>
                            ...
                            <form action="<?= base_url('admin/documentos/actualizar') ?>" method="post" class="space-y-2">
                                ...
                                <select name="estatus" id="estatus-<?= $docSubido['id'] ?>" class="w-full border-gray-300 rounded"
                                ...
                                <select name="observaciones" id="observaciones-<?= $docSubido['id'] ?>" class="w-full border-gray-300 rounded px-2 py-1"
                                    <?= $docSubido['estatus'] == 2 ? 'disabled' : '' ?> onchange="this.form.submit()">
