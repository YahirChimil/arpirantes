                                ...
                                <div class="card-body grid gap-5">
                                    ...
                                    <div class="w-full">
                                        <div class="flex items-baseline flex-wrap lg:flex-nowrap gap-2.5">
                                            ...
                                            <input data-tooltip="#tooltip_link" name="link" id="link"
                                                maxlength="500" minlength="3" class="input" type="text"  value="" required />
                                        </div>
                                        <div class="tooltip" id="tooltip_link"> El link no debe contener espacios. </div>
                                    </div>
                                    <div class="w-full">
                                        <div class="flex items-baseline flex-wrap lg:flex-nowrap gap-2.5">
                                            <label class="form-label flex items-center gap-1 max-w-56">
                                        ...
                                        <div class="tooltip" id="tooltip_link"> . </div>
                                    </div>
                                    <div class="w-full">
                                        <div class="flex items-baseline flex-wrap lg:flex-nowrap gap-2.5">
                                            <label class="form-label flex items-center gap-1 max-w-56">
