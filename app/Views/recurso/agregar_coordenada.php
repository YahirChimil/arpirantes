                                ...
                                <div class="card-body grid gap-5">
                                    ...
                                    <div class="w-full">
                                        <div class="flex items-baseline flex-wrap lg:flex-nowrap gap-2.5">
                                            ...
                                            <input data-tooltip="#tooltip_lat" name="lat" id="lat"
                                                maxlength="30" minlength="3" class="input" type="number" step="any" min="0" value="" required/>
                                        </div>
                                        <div class="tooltip" id="tooltip_lat"> La latitud debe estar en formato decimal. </div>
                                    </div>
                                    <div class="w-full">
                                        <div class="flex items-baseline flex-wrap lg:flex-nowrap gap-2.5">
                                            <label class="form-label flex items-center gap-1 max-w-56">
                                            ...
                                            <input data-tooltip="#tooltip_lon" name="lon" id="lon"
                                                maxlength="30" minlength="3" class="input" type="number" step="any" min="0" value="" required />
                                        </div>
                                        <div class="tooltip" id="tooltip_lon"> La longitud debe estar en formato decimal. </div>
                                    </div>
