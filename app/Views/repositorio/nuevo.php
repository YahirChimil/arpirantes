                            ...
                            <div class="card pb-2.5">
                                ...
                                <div class="card-body grid gap-5">
                                    ...
                                    <div class="flex items-center flex-wrap gap-2.5">
                                        ...
                                        <div class="grow">
                                            <select class="select" name="estatus" id="estatus" required>
                                            <option value="">
                                    ...
                                    <div class="flex items-center flex-wrap gap-2.5">
                                        ...
                                        <div class="grow">
                                        <select class="select select2-temas" name="estado[]" id="estado" multiple="multiple" required>
                                    ...
                                    <div class="flex items-center flex-wrap gap-2.5">
                                        ...
                                        <div class="grow">
                                        <select class="select select2-temas" name="clasificacion[]" id="clasificacion" multiple="multiple" required>
                                        <?php foreach ($clasificacion as $c ) {  ?>
                                            <option value="<?php echo $c['id']; ?>"><?php echo $c['clasificacion']; ?> - <?php echo $c['tema']; ?></option>
                                        <?php } ?>
                                        </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="w-full">
                                        <div class="flex items-baseline flex-wrap lg:flex-nowrap gap-2.5">
                                            ...
                                            <input class="checkbox" name="confirmo" id="confirmo" type="checkbox" value="1"/><p class="form-label">Confirmo que soy autor o tengo la autorizacion expresa de subir este recurso</p> 
                                        </div>
                                    </div>
                                    <div class="flex justify-end pt-2.5">
                                        <input class="btn btn-primary" value="Crear repositorio" type="submit">
                                    </div>
                                </div>
                            </div>
